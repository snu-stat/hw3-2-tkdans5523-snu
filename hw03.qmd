...
```{python}
# 데이터 불러오기 및 이름 변경 (R Lahman과 컬럼명 통일)
Teams = pl.from_pandas(pylahman.Teams())
rename_map = {"2B": "X2B", "3B": "X3B", "IPOuts": "IPouts"}
Teams = Teams.rename({k: v for k, v in rename_map.items() if k in Teams.columns})
